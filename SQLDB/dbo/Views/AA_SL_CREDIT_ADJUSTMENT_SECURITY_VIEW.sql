create view AA_SL_CREDIT_ADJUSTMENT_SECURITY_VIEW
/*
** Written:			5/4/2004 RL
** Last Amended: 
** Comments: 		Returns Security Profile settings for Sales Credit Adjustments (Decrease Customer Balance)
*/
as
select
...
cast (substring(UP_TRAN_OPTIONS5, 7, 1) as tinyint) as BYPASS_COSTING,
(case 
   when substring(UP_TRAN_OPTIONS5, 8, 1) = 'Y' then cast(1 as tinyint)
   else cast(0 as tinyint)
   end)
as SUB_LEDGER,
(case 
