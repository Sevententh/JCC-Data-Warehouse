create view AA_PL_BATCH_HEADER_SIMPLE_VIEW
/*
** Written:      
** Last Amended: 22/02/2005 SR, 01/03/2005 SR, 03/03/2005 SH, 11/07/2005 SH, 23/08/2005 SH, 26/10/2005 JC
*/
as

select
 cast(PT_PRIMARY as int) as [PRIMARY]
,PT_COPYSUPP
