create view AA_CST_EXTRA_WORK_SIMPLE_VIEW
/*
** Returns a table to be used specifically with AA_CST_EXTRA_WORK_LIST_S
**
...
,  InvoiceableValue_C-UpliftedCostValue_C                                      as Markup_C
   ...
   (
      ...
      ,  UpliftedCostValue-CT_UNRECOV_VALUE                                   as OutstandingValue
      ,  UpliftedCostValue_C-CT_UNRECOV_VALUE_C                               as OutstandingValue_C
      ,  0                                                                    as Flag
      ,  (
            dbo.AA_VALUE_DPS_F
            (
            ...
            (
               ...
               ,  dbo.AA_VALUE_DPS_F
                  ...
                  (
                     ...
                     ,  dbo.AA_VALUE_DPS_F(CT_UNRECOV_VALUE)                  as CT_UNRECOV_VALUE
                     ,  dbo.AA_VALUE_DPS_F(CT_UNRECOV_VALUE_C)                as CT_UNRECOV_VALUE_C
                     ,  dbo.AA_VALUE_DPS_F(CT_VALUE_INVOICED)                 as CT_VALUE_INVOICED
                     ,  dbo.AA_QUANTITY_DPS_F(CT_EXTRA_WORK_QUANTITY)         as ExtraWorkQuantity
                     ,  dbo.AA_VALUE_DPS_F(CT_EXTRA_WORK_VALUE)               as ExtraWorkValue
                     ,  dbo.AA_VALUE_DPS_F(CT_EXTRA_WORK_VALUE_C)             as ExtraWorkValue_C
                        from
                           CST_DETAIL
                        where
                                 CT_ALLOCATED   = 0
