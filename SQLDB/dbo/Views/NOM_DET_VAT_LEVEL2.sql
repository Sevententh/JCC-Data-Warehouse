CREATE VIEW NOM_DET_VAT_LEVEL2
/*
** Written:
** Last Amended: 22/10/02, 01/12/03 SR, 24/05/05 SR,7/6/05chw, 19/04/06 SRB, 19/10/2010 CC
**
*/
(
...
end),DET_PRIMARY,DET_NOMINALVAT,DET_QUANTITY,DET_DIMENSION1,DET_DIMENSION2,DET_DIMENSION3,DET_ARCHIVE_FLG,DET_VATCODE
