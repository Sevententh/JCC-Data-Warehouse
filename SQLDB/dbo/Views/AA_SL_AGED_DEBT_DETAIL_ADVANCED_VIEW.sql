create view AA_SL_AGED_DEBT_DETAIL_ADVANCED_VIEW
as
/*
**
** Written:      
...
,dbo.AA_VALUE_DPS_F(DET_VAT_BASE2) * case when DET_TYPE in ('INV','ADR','JDR') then 1 else -1 end as DET_VAT_BASE2
...
,dbo.AA_VALUE_DPS_F(OD_LINEDISC) as OD_LINEDISC
,dbo.AA_VALUE_DPS_F(OH_DISC_TOTAL_P) as OH_DISC_TOTAL_P
,DET_SUB_AUDIT_NO
