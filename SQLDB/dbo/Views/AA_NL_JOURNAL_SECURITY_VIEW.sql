create view AA_NL_JOURNAL_SECURITY_VIEW
/*
** Written:			5/4/2004 RL
** Last Amended: 
** Comments: 		Returns Security Profile settings for Nominal Journals
*/
as
select
...
as OPTIONS,
cast (substring(UP_TRAN_OPTIONS1, 3, 1) as tinyint) as POST_BALANCE_TO_CONTRA,
cast (substring(UP_TRAN_OPTIONS1, 4, 1) as tinyint) as MULTIPLE_CONTRAS,
cast (substring(UP_TRAN_OPTIONS1, 5, 1) as tinyint) as ENTER_CURRENCY_AMOUNTS,
...
cast (substring(UP_TRAN_OPTIONS1, 8, 1) as tinyint) as RECURRING_JOURNAL,
