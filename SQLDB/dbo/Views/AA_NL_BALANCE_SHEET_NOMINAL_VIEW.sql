CREATE VIEW AA_NL_BALANCE_SHEET_NOMINAL_VIEW
AS 
/*
** 
** Intended to be called by AA_NL_BALANCE_SHEET_NOMINAL_S
...
**          Period (1-13)                    - PERIOD
**
** The following fields have been moved to AA_NL_BS_YTD_NOMINAL_VIEW which is intended to be used with this one:
...
** Last Amended: 13/10/2005 SB, 10/11/2005 SB, 20/01/2006 SB
*/
