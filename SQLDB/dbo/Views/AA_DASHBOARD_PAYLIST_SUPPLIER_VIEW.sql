CREATE VIEW AA_DASHBOARD_PAYLIST_SUPPLIER_VIEW
...
SELECT     TOP 100 PERCENT dbo.SYS_USER.USER_ID, dbo.PL_TRANSACTIONS.PT_COPYSUPP, 
		...
		SUM(dbo.PL_TRANSACTIONS.PT_UNALLOCATED) AS PT_UNALLOCATED, COUNT(*) AS RECS, 
                      dbo.PL_TRANSACTIONS.PT_PAY_STAGE_STATUS, dbo.PL_TRANSACTIONS.PT_CURRENCYCODE
...
GROUP BY dbo.SYS_USER.USER_ID, dbo.PL_TRANSACTIONS.PT_COPYSUPP, dbo.PL_TRANSACTIONS.PT_PAY_STAGE_STATUS, 
                      dbo.PL_TRANSACTIONS.PT_CURRENCYCODE,dbo.PL_TRANSACTIONS.PT_TRANTYPE
ORDER BY dbo.PL_TRANSACTIONS.PT_COPYSUPP
