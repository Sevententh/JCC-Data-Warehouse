CREATE VIEW TS_LOOKUP_PROJECT_NOCONTRACT_WFF AS
-- TS_LOOKUP_PROJECT_NOCONTRACT_WFFVersion 1
-- Written by Stefan Smidak 22/11/2012
-- View used by WFF project lookup to return non contact projects
-- Version History:
...
LEFT OUTER JOIN CST_CONTRACTS on CCON_PRIMARY=CH_CONTRACT_LINK where CH_CODE!='' and (CCON_PRIMARY is null or CCON_MASTER_PROJECT_LINK<>CH_PRIMARY)