create view AA_NL_ACCOUNT_ADVANCED_VIEW
/*
** Returns a table to be used specifically with AA_NL_RECORD_LIST_S
** Written:      27/02/03 SRB
** Last Amended: 13/03/03 ROBB; 25/03/03 SRB; 03/03/04 DG; 26/05/04 DG; 11/08/04 DG; 13/01/05 SR, 25/04/2005 SH; 08/07/05 SRB, 03/08/2005 SH; 07/09/05 SRB, 27/09/2005 SB, 13/12/05 NC
**
*/
as
...
,cast(n2.N_USRFLAG1 as bit) as N_USRFLAG1
,cast(n2.N_USRFLAG2 as bit) as N_USRFLAG2
,cast(n2.N_USRFLAG3 as bit) as N_USRFLAG3
,n2.N_USRDATE1
,n2.N_USRDATE2
,n2.N_USRDATE3
...
inner join SYS_DATAINFO s with ( nolock) on S.SYS_PRIMARY = 1
