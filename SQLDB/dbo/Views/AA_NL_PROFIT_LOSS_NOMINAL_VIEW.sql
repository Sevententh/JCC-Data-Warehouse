CREATE VIEW AA_NL_PROFIT_LOSS_NOMINAL_VIEW
AS
/*
** 
** Intended to be called by AA_NL_PROFIT_LOSS_NOMINAL_S
...
**
** The following fields are required by the view AA_NL_PL_YTD_NOMINAL_VIEW and the procedure AA_NL_PROFIT_LOSS_NOMINAL_S:
**          B_ACCOUNT_CODE
**          B_YEAR
**          B_PERIOD
**          NTURNOVER
**
** The following fields are now calculated from data accessed through AA_NL_PL_YTD_NOMINAL_VIEW and are no longer in
** this view:
...
** Last Amended: 13/10/2005 SB, 10/11/2005 SB, 22/12/2005 SB
*/
select V.[PRIMARY]
      ,V.LINK_PRIMARY
      ,V.NCODE 
      ,V.NNAME
      ,V.NCODE + '/'+ V.NNAME DESCRIPTION
      ,V.NCATCODE 
      ,V.NCATNAME
      ,V.NCATEGORY
