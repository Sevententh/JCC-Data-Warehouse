create view AA_NL_DEBIT_VAT_JOURNAL_SECURITY_VIEW
/*
** Written:			5/4/2004 RL
** Last Amended: 
** Comments: 		Returns Security Profile settings for Nominal Debit VAT Journals
*/
as
select
...
as OPTIONS,
cast (substring(UP_TRAN_OPTIONS3, 3, 1) as tinyint) as MULTIPLE_CONTRAS,
cast (substring(UP_TRAN_OPTIONS3, 4, 1) as tinyint) as ENTER_CURRENCY_AMOUNTS,
...
cast (substring(UP_TRAN_OPTIONS3, 7, 1) as tinyint) as RECURRING_JOURNAL,
