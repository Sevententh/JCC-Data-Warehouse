create view AA_CST_CC_TURNOVER_NEXT_YEAR_CURR_VIEW
/*
...
from 
   ...
   on PERIOD = CURR_TURNOVERS.CT_PERIODNUMBR 
      and C.CC_CODE = CURR_TURNOVERS.CT_COSTCENTRE
      and C.CH_CODE = CURR_TURNOVERS.CT_COSTHEADER
--WHERE CH_PRIMARY = 15
