CREATE VIEW AA_IH_ED_SOP_DETAIL_ANALYSIS_VIEW
/*
** Written:			1/1/2006 RQ
** Last Amended:	
*/
...
OD_COSTHEADER,CH_NAME,OD_PRIMARY,OH_PRIMARY,OD_LOCATN,OD_ORDER_NUMBER,OD_BATCH_FLAG,
	CASE OH_TYPE
		WHEN 'O' THEN OD_COSTPRICE*OD_QTYORD
		WHEN 'C' THEN (OD_COSTPRICE*-1)*OD_QTYORD END AS COSTVALUE
FROM ORD_DETAIL
...
WHERE OD_PRIMARY IS NOT NULL AND OH_TYPE='O' AND OH_YEAR='C'