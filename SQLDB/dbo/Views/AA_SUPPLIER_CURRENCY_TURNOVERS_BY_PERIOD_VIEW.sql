create view AA_SUPPLIER_CURRENCY_TURNOVERS_BY_PERIOD_VIEW
/*
** Written:
** Last Amended:
**
...
from
   (select
          c.SUCODE                                            SupplierCode
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C1_C)                TurnoverCYP1C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C2_C)                TurnoverCYP2C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C3_C)                TurnoverCYP3C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C4_C)                TurnoverCYP4C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C5_C)                TurnoverCYP5C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C6_C)                TurnoverCYP6C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C7_C)                TurnoverCYP7C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C8_C)                TurnoverCYP8C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C9_C)                TurnoverCYP9C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C10_C)               TurnoverCYP10C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C11_C)               TurnoverCYP11C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C12_C)               TurnoverCYP12C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C13_C)               TurnoverCYP13C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L1_C)                TurnoverLYP1C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L2_C)                TurnoverLYP2C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L3_C)                TurnoverLYP3C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L4_C)                TurnoverLYP4C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L5_C)                TurnoverLYP5C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L6_C)                TurnoverLYP6C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L7_C)                TurnoverLYP7C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L8_C)                TurnoverLYP8C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L9_C)                TurnoverLYP9C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L10_C)               TurnoverLYP10C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L11_C)               TurnoverLYP11C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L12_C)               TurnoverLYP12C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_L13_C)               TurnoverLYP13C
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C1_C)                [1]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C2_C)                [2]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C3_C)                [3]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C4_C)                [4]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C5_C)                [5]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C6_C)                [6]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C7_C)                [7]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C8_C)                [8]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C9_C)                [9]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C10_C)               [10]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C11_C)               [11]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C12_C)               [12]
         ,dbo.AA_VALUE_DPS_F(c.SUTURNOVR_C13_C)               [13]
      from PL_ACCOUNTS c with (nolock)
   ) p
UNPIVOT
