create view AA_NL_TRANSACTION_THREESIXTY_DETAIL_VIEW
/*
...
,  isnull(N4.NNAME,'')                                                                    as STOCK_NOMINALCR_NAME
   from
      SL_PL_NL_DETAIL D
         left join SL_ANALYSIS      S1 on       S1.SACODE         = D.DET_ANALYSIS
                                          and   D.DET_ORIGIN      in
                                                                  (
                                                                     'S'
                                                                  ,  'SO'
