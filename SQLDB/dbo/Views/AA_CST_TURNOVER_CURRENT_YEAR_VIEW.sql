create view AA_CST_TURNOVER_CURRENT_YEAR_VIEW
/*
...
from 
   (  select PERIOD
      , CH_PRIMARY
      , cast(case
            when PERIOD = 1  then CH.CH_COST_C_1       
            when PERIOD = 2  then CH.CH_COST_C_2   
            when PERIOD = 3  then CH.CH_COST_C_3   
            when PERIOD = 4  then CH.CH_COST_C_4   
            when PERIOD = 5  then CH.CH_COST_C_5   
            when PERIOD = 6  then CH.CH_COST_C_6   
            when PERIOD = 7  then CH.CH_COST_C_7   
            when PERIOD = 8  then CH.CH_COST_C_8   
            when PERIOD = 9  then CH.CH_COST_C_9   
            when PERIOD = 10 then CH.CH_COST_C_10  
            when PERIOD = 11 then CH.CH_COST_C_11  
            when PERIOD = 12 then CH.CH_COST_C_12  
            when PERIOD = 13 then CH.CH_COST_C_13  
