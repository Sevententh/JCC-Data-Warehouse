...
CREATE VIEW [dbo].[JCC_Deliverable_Report_Data]

/*
** Written     :  13/07/2015 AKT
** Last Amended:  04/10/2017 AKT	
**
*/
...
SELECT CASE WHEN [OH_TYPE] = 'O' THEN 'Sales Order'
      ...
      ,[STK_ALLOC_QTYALLOC] as 'Quantity Allocated'
      ,[STK_ALLOC_QTYALLOC] * [OD_UNITCST] as 'Value Allocated'
  ...
  LEFT OUTER JOIN [JCC_PROD_LIVE].[dbo].[STK_ALLOCATIONS]
  ON [OD_PRIMARY] = [STK_ALLOC_OD_LINK]
