create view AA_PL_REMITTANCES_CHEQUES_SIMPLE_VIEW
/*
** Returns a table to be used specifically with AA_PL_REMITTANCES_CHEQUES_LIST_S
** Written: 17/02/2005 SH
** Last Amended: 08/04/2005 SRB; 01/06/05; 01/11/05 SRB;
**
*/
as
